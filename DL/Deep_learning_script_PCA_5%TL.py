...
model = tf.keras.models.load_model("C:\Mannu\QMBCE\Thesis\Fold\_8comps_PCA_05_k_fold_publish_01_trial\lBaseline_CNN_0_3_Model.tf")
print(model)
inputs = model.input
output = model.output
...
transfer_lr_model.save('C:\Mannu\QMBCE\Thesis\Fold\_8comps_PCA_05_k_fold_publish_01\Transfer_lr_model_5%.tf')
...
cr = cr.iloc[1:]
cr.to_csv('C:\Mannu\QMBCE\Thesis\Fold\_8comps_PCA_05_k_fold_publish_01\classification_report_transfer_learning.csv')
