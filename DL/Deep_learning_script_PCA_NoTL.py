...
def graph_history_averaged(combined_history):
    ...
    plt.tight_layout()
    plt.grid(False)
    plt.savefig("C:\Mannu\QMBCE\Thesis\Fold\_8comps_PCA_00_k_fold_publish_01\Averaged_graph.png", dpi = 500, bbox_inches="tight")
    plt.close()
...
# Select the optimal number of componets 
...
savedir = (outdir+"\_8comps_PCA_00_k_fold_publish_01")            
build_folder(savedir, True)
savedir = (outdir+"\_8comps_PCA_00_k_fold_publish_01\l")            
...
with open('C:\Mannu\QMBCE\Thesis\Fold\_8comps_PCA_00_k_fold_publish_01\combined_history_dictionaries.txt', 'w') as outfile:
...
model_pred = tf.keras.models.load_model("C:\Mannu\QMBCE\Thesis\Fold\_8comps_PCA_00_k_fold_publish_01\lBaseline_CNN_0_2_Model.h5")
