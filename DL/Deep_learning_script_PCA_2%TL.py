...
df_3 = pd.read_csv("C:\Mannu\QMBCE\Thesis\set_to_train_glasgow_02.csv")
print(df_3.head())
...
def graph_history_averaged(combined_history):
    ...
    plt.tight_layout()
    plt.grid(False)
    plt.savefig("C:\Mannu\QMBCE\Thesis\Fold\_8comps_PCA_02_k_fold_publish_01\Averaged_graph.png", dpi = 500, bbox_inches="tight")
    plt.close()
...
# dim_reduction = decomposition.PCA(n_components = 15).fit(X = X_transformed)
...
with open('C:\Mannu\QMBCE\Thesis\Fold\_8comps_PCA_02_k_fold_publish_01\combined_history_dictionaries.txt', 'w') as outfile:
...
model = tf.keras.models.load_model("C:\Mannu\QMBCE\Thesis\Fold\_8comps_PCA_02_k_fold_publish_01\lBaseline_CNN_0_3_Model.h5")
...
cr = cr.iloc[1:]
cr.to_csv('C:\Mannu\QMBCE\Thesis\Fold\_8comps_PCA_02_k_fold_publish_01\classification_report.csv')
