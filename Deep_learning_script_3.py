...
savedir = (outdir+"\Training_Folder_8comps_PCA_00_k_fold_4")            
build_folder(savedir, True)
savedir = (outdir+"\Training_Folder_8comps_PCA_00_k_fold_4\l")            
...
reconstracted_model = tf.keras.models.load_model("C:\Mannu\QMBCE\Thesis\Fold\Training_Folder_8comps_PCA_00_k_fold_4\lBaseline_CNN_0_2_Model.h5")
...
cr = cr.iloc[1:]
cr.to_csv('C:\Mannu\QMBCE\Thesis\Fold\Training_Folder_8comps_PCA_00_k_fold_4\classification_report_PCA_8_5%.csv')
...
savedir = (outdir+"\Training_Folder_8comps_tsne_05%_deep")            
build_folder(savedir, True)
savedir = (outdir+"\Training_Folder_8comps_tsne_05%_deep\l")            
...
reconstracted_model = tf.keras.models.load_model("C:\Mannu\QMBCE\Thesis\Fold\Training_Folder_8comps_tsne_05%_deep\lBaseline_CNN_0_2_Model.h5")
...
cr_tsne.to_csv('C:\Mannu\QMBCE\Thesis\Fold\Training_Folder_8comps_tsne_05%_deep\classification_report_tsne_05%_deep.csv')
