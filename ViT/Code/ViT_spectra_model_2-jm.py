...
from functions import build_folder
...
#     print(f"Shape after Flatten: {flat_patches.shape}")
    ...
    projection = layers.Dense(128,
                              ...
                              kernel_regularizer=regularizers.l2(regConst))(inputs)  # Linear projection to a higher dimension
    ...
    print(f"Shape before GlobalAveragePooling1D: {x.shape}")
...
def create_transfer_learning_model(base_model, num_classes, learning_rate=0.001, reg_const=0.01):
    '''
    Function to create a transfer learning model based on a pre-trained model
