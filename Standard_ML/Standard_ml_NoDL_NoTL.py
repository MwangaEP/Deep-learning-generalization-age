...
# No dimesionality reduction, no Trasfer learning
...
for round in range(num_rounds):
    ...
    for train_index, test_index in kf.split(X_trans, y):
...
# Predicting the whole glasgow dataset
...
print(glasgow_unseen_df.head(10))
...
X_valid = glasgow_unseen_df.iloc[:,:-1]
y_valid = glasgow_unseen_df["Age_group_new"]
...
X_valid = scl.transform(X = X_valid)
