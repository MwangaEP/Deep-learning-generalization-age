...
classifier.save_model('C:\Mannu\QMBCE\Thesis\Fold\Standard_ml\_ml_pca_2\classifier')
...
transfer_model = classifier.fit(age_pca_new, y_new, xgb_model = 'C:\Mannu\QMBCE\Thesis\Fold\Standard_ml\_ml_pca_2\classifier') # 'classifier.get_booster()

with open('C:\Mannu\QMBCE\Thesis\Fold\Standard_ml\_ml_pca_2\Transfer_model.pkl', 'wb') as fid:
