...
def plot_confusion_matrix(cm, classes,
    ...
    plt.savefig(("C:\Mannu\QMBCE\Thesis\Fold\Standard_ml\_ml_2\Confusion_Matrix_" + figure_name + "_" + ".png"), dpi = 500, bbox_inches="tight")
...
rf_per_class_acc_distrib.dropna().to_csv("C:\Mannu\QMBCE\Thesis\Fold\Standard_ml\_ml_2\_rf_per_class_acc_distrib.csv")
rf_per_class_acc_distrib = pd.read_csv("C:\Mannu\QMBCE\Thesis\Fold\Standard_ml\_ml_2\_rf_per_class_acc_distrib.csv", index_col=0)
...
rf_per_class_acc_distrib_describe.to_csv("C:\Mannu\QMBCE\Thesis\Fold\Standard_ml\_ml_2\_rf_per_class_acc_distrib.csv")
...
plt.grid(False)
plt.tight_layout()
plt.savefig("C:\Mannu\QMBCE\Thesis\Fold\Standard_ml\_ml_2\_rf_per_class_acc_distrib.png", dpi = 500, bbox_inches="tight")


#%%

# transfer learning 
# start by reading 2% of the glasgow training data from the disk 
...
transfer_model = classifier.fit(age_new, y_new, xgb_model = 'C:\Mannu\QMBCE\Thesis\Fold\Standard_ml\_ml_2\classifier') # 'classifier.get_booster()

with open('C:\Mannu\QMBCE\Thesis\Fold\Standard_ml\_ml_2\Transfer_model.pkl', 'wb') as fid:
...
# with open('C:\Mannu\QMBCE\Thesis\Fold\Standard_ml\_ml_pca_2\Transfer_model.pkl', 'rb') as fid:
...
cr = cr.iloc[1:]
cr.to_csv('C:\Mannu\QMBCE\Thesis\Fold\Standard_ml\_ml_2\classification_report.csv')
