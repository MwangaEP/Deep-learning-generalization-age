...
# Principal component analysis is used to reduce the dimensionality of the data, No transfer learning
...
def plot_confusion_matrix(cm, classes,
    ...
    plt.savefig(("C:\Mannu\QMBCE\Thesis\Fold\Standard_ml\_ml_pca_0\Confusion_Matrix_" + figure_name + "_" + ".png"), dpi = 500, bbox_inches="tight")
...
rf_per_class_acc_distrib.dropna().to_csv("C:\Mannu\QMBCE\Thesis\Fold\Standard_ml\_ml_pca_0\_rf_per_class_acc_distrib.csv")
rf_per_class_acc_distrib = pd.read_csv("C:\Mannu\QMBCE\Thesis\Fold\Standard_ml\_ml_pca_0\_rf_per_class_acc_distrib.csv", index_col=0)
...
rf_per_class_acc_distrib_describe.to_csv("C:\Mannu\QMBCE\Thesis\Fold\Standard_ml\_ml_pca_0\_rf_per_class_acc_distrib.csv")
...
plt.grid(False)
plt.tight_layout()
plt.savefig("C:\Mannu\QMBCE\Thesis\Fold\Standard_ml\_ml_pca_0\_rf_per_class_acc_distrib.png", dpi = 500, bbox_inches="tight")

#%%

# save the trained model to disk for future use

with open('C:\Mannu\QMBCE\Thesis\Fold\Standard_ml\_ml_pca_0\classifier.pkl', 'wb') as fid:
...
glasgow_unseen_df = pd.read_csv("C:\Mannu\QMBCE\Thesis\glasgow_data.dat", delimiter = '\t')

# Checking class distribution in glasgow data 
print(Counter(glasgow_unseen_df["Age"]))

# drops columns of no interest
glasgow_unseen_df = glasgow_unseen_df.drop(['Species', 'Status', 'Country', 'RearCnd', 'StoTime'], axis=1)
...
with open('C:\Mannu\QMBCE\Thesis\Fold\Standard_ml\_ml_pca_0\classifier.pkl', 'rb') as fid:
...
cr = cr.iloc[1:]
cr.to_csv('C:\Mannu\QMBCE\Thesis\Fold\Standard_ml\_ml_pca_0\classification_report_PCA_8_0.csv')
