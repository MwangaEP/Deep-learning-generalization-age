...
# of Anopheles arabiensis mosquitoes reared in different insectaries (Ifakara and Glasgow) (5% transfer learning)
...
def plot_confusion_matrix(cm, classes,
    ...
    plt.savefig(("C:\Mannu\QMBCE\Thesis\Fold\Standard_ml\_ml_tsne_5\Confusion_Matrix_" + figure_name + "_" + ".png"), dpi = 500, bbox_inches="tight")
...
rf_per_class_acc_distrib.dropna().to_csv("C:\Mannu\QMBCE\Thesis\Fold\Standard_ml\_ml_tsne_5\_rf_per_class_acc_distrib.csv")
rf_per_class_acc_distrib = pd.read_csv("C:\Mannu\QMBCE\Thesis\Fold\Standard_ml\_ml_tsne_5\_rf_per_class_acc_distrib.csv", index_col=0)
...
rf_per_class_acc_distrib_describe.to_csv("C:\Mannu\QMBCE\Thesis\Fold\Standard_ml\_ml_tsne_5\_rf_per_class_acc_distrib.csv")
...
cr = cr.iloc[1:]
cr.to_csv('C:\Mannu\QMBCE\Thesis\Fold\Standard_ml\_ml_tsne_5\classification_report_tsne_.csv')
